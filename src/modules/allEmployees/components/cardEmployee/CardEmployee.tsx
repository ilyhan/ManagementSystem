    ...
    return (
        <article className='card-employee__wrapper'>
            <div className='card-employee__header'>
                <div className={`card-employee__avatar card-employee__avatar_${color}`}>
                    {firstLetter}
                </div>

                <div>
                    <p className='card-employee__name'>
                        {fullName}
                    </p>

                    {grade &&
                        <p className='card-employee__grade'>
                            {grade}
                        </p>
                    }
                </div>
            ...
            <div className='card-employee__contact'>
                <div className='card-employee__contact-info'>
                    <p className='card-employee__contact-type'>
                        E-mail:
                    </p>
                    <p>{email}</p>
                </div>
