  ...
  return (
    <article className="preview-task">
      <div className="preview-task__content">
        <p className="preview-task__title">{title}</p>

        <p className="preview-task__board">{boardName}</p>
      </div>
      ...
      {open && <UpdateModal open={open} onClose={handleClose} taskId={id} boardId={board_id} />}
    </article>
  );
};
